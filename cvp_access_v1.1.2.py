...
def verify_track_state(port, track, attempts=3):
...
def verify_style_volume(port, attempts=3):
...
def main():
    ...
    for event in keyboard.read_loop():
        ...
        if event.code == ecodes.KEY_PAGEUP:
            ...
            verified_volume = verify_style_volume(port)
