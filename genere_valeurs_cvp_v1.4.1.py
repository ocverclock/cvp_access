...
# ============================================================
# VOIX MODULAIRES : POSITION SONG
# ============================================================
#
# Banque simple et limitée :
# mesure.wav + nombre_000..100.wav + temps.wav + nombre_000..100.wav

for number in range(0, 101):

    generate(
        str(number),
        NUMBER_DIR / f"number_{number:03d}.wav"
    )
...
for filename, phrase in TRANSPORT_VOICES:
