...
frontend_160_source = (root / "cvp_access_1_6_0.py").read_text(encoding="utf-8")
assert 'VERSION = "1.6.0-RC1"' in frontend_160_source
assert 'CVP_RECORDER_ENABLED' in frontend_160_source
assert "cvp_access_1_5_2" in frontend_160_source
...
assert "CVP_RECORDINGS_DIR=@RECORDINGS_DIR@" in service_template_source
...
assert "install_midi_recorder" in runtime_source
...
assert "[CVP_recordings]" in samba_source
assert "@RECORDINGS_DIR@" in samba_source
...
upgrade_160_source = (
    root / "cvp_access_installer/upgrade_1_6_0.sh"
).read_text(encoding="utf-8")
assert "upgrade_1_6_0.sh" in fresh_install_source
assert "upgrade_1_6_0.sh" in update_source
...
assert 'CVP_FRONTEND_SOURCE="cvp_access_1_6_0.py"' in upgrade_160_source
assert 'CVP_TARGET_VERSION="1.6.0-RC1"' in upgrade_160_source
assert "unset-environment CVP_RECORDER_PROBE" in upgrade_160_source
...
print("CVP Access 1.6.0 RC1 package: OK")
