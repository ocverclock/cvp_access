...
## v1.5 RC4-dev — Style sections et Registration

Validation materielle : Yamaha CVP-905 firmware 1.03.

Nouvelles actions configurables :
...
Aucun nouveau binding n'est impose dans config/default.toml.
...
Le Fingering Type reste en recherche.
Voir CVP905_PROTOCOL_CHECKPOINT_RC4.md.
